                ...
                <div className="p-6 border-b border-white/50 flex items-start justify-between gap-4">
                    <div className="flex items-start space-x-3.5 flex-1 min-w-0">
                        <button
                            ...
                            className={`mt-1 w-8 h-8 rounded-xl neu-button flex items-center justify-center shrink-0 transition-transform ${isCompleted
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center space-x-2 flex-wrap gap-1.5">
                                <h2
                                    className={`text-xl sm:text-2xl font-extrabold text-[#1a1c35] break-words ${isCompleted ? 'line-through text-[#717699]/80 font-normal' : ''
                                        }`}
                                >
                                    {task.title}
                                </h2>
                            ...
                            <div className="flex items-center space-x-3 mt-2 flex-wrap gap-y-1">
                                ...
                                {timeLeftStr && (
                                    <div
                                        className={`flex items-center space-x-1 text-xs font-bold px-2.5 py-0.5 rounded-lg neu-badge ${timeLeftStr === 'Overdue'
                        ...
                        <div className="space-y-2">
                            {subtasks.map((st) => (
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            className={`w-5 h-5 rounded-lg flex items-center justify-center shrink-0 border ${st.done
                                        ...
                                        <span
                                            className={`text-sm font-medium text-[#1a1c35] truncate ${st.done ? 'line-through text-[#717699]' : ''
                                                }`}
                                        >
                                            {st.text}
                                        </span>
