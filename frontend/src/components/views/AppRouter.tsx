...
import { MasterStreakBanner } from '../MasterStreakBanner';
...
interface AppRouterProps {
  ...
  navigateToView: (view: 'landing' | 'visible' | 'private' | 'stats' | 'auth') => void;
...
export const AppRouter: React.FC<AppRouterProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <MasterStreakBanner stats={stats} onCheckInToday={onCheckInToday} />
