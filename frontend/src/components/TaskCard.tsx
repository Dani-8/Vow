...
export const TaskCard: React.FC<TaskCardProps> = ({
  ...
  return (
    <div
      className={`neu-card p-6 transition-all duration-300 relative group ${
        isCompleted
      ...
      <div className="flex items-start justify-between gap-3 mb-3">
        ...
        <div className="flex items-start space-x-3.5 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center space-x-2 flex-wrap gap-y-1">
              <h3
                className={`text-lg font-bold text-[#1a1c35] truncate ${
        ...
        <div className="flex items-center space-x-1 shrink-0 opacity-90 group-hover:opacity-100 transition-opacity">
          ...
          <button
            ...
            className={`px-2.5 py-1.5 rounded-xl neu-button flex items-center space-x-1.5 text-xs font-bold ${
              isStruggling
