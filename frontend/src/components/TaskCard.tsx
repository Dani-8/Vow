...
export const TaskCard: React.FC<TaskCardProps> = ({
  ...
  return (
    <div
      className={`neu-card p-4 transition-all duration-300 relative group ${
        isCompleted
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3 mb-2">
        ...
        <div className="flex items-start space-x-3 flex-1 min-w-0">
          <button
            ...
            className={`mt-0.5 w-7 h-7 rounded-xl neu-button flex items-center justify-center shrink-0 transition-transform ${
              isCompleted
          ...
          >
            <div className="flex items-center space-x-2 flex-wrap gap-1.5">
              <h3
                className={`text-base font-bold text-[#1a1c35] group-hover/click:text-[#549acb] transition-colors break-words ${
                  isCompleted ? 'line-through text-[#717699] font-normal' : ''
                }`}
              >
                {task.title}
              </h3>
            ...
            {task.description && (
              <p
                className={`text-xs text-[#717699] mt-1 leading-snug line-clamp-2 break-words w-full ${
                  isCompleted ? 'text-[#717699]/70' : ''
                }`}
              >
                {task.description}
              </p>
      ...
      <div className="pt-3 border-t border-white/40 flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex items-center space-x-3 text-xs">
          {/* Current Streak */}
          <div
            className={`flex items-center space-x-1.5 px-2.5 py-1 rounded-xl neu-badge ${
              currentStreak > 0
        ...
        {timeLeftStr && (
          <div
            className={`flex items-center space-x-1 text-xs font-bold px-2.5 py-1 rounded-xl neu-badge ${
              timeLeftStr === 'Overdue'
