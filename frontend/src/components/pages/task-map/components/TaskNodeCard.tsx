                ...
                {isStatusSubmenuOpen && (
                  ...
                  >
                    <button
                      ...
                      className={`w-full text-left px-2.5 py-1.5 rounded-lg flex items-center justify-between text-emerald-700 hover:bg-emerald-100 transition-colors cursor-pointer ${
                        status === 'completed' ? 'bg-emerald-100/90 font-black' : ''
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`w-full text-left px-2.5 py-1.5 rounded-lg flex items-center justify-between text-sky-700 hover:bg-sky-100 transition-colors cursor-pointer ${
                        status === 'in_progress' ? 'bg-sky-100/90 font-black' : ''
                      }`}
                    >
                      <span className="flex items-center space-x-1.5">
                    ...
                    <button
                      ...
                      className={`w-full text-left px-2.5 py-1.5 rounded-lg flex items-center justify-between text-gray-700 hover:bg-gray-200/80 transition-colors cursor-pointer ${
                        status === 'todo' ? 'bg-gray-200/80 font-black' : ''
                      }`}
                    >
                      <span className="flex items-center space-x-1.5">
