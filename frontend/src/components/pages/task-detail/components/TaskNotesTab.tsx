            ...
            {(['yellow', 'green', 'blue', 'purple', 'rose', 'gray'] as NoteColor[]).map((c) => {
              ...
              return (
                <button
                  ...
                  className={`w-6 h-6 rounded-full transition-transform flex items-center justify-center ${theme.accentDot} ${
                    colorFilter === c ? 'scale-125 ring-2 ring-indigo-500 ring-offset-2 ring-offset-[#E0E5EC]' : 'hover:scale-110 opacity-80 hover:opacity-100'
                  }`}
