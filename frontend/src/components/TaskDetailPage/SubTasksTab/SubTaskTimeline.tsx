          ...
          filteredSubTasks.map((st) => {
            ...
            return (
              <div
                ...
                className={`group flex items-center space-x-2 sm:space-x-3 p-3 rounded-2xl cursor-pointer transition-all ${
                  isDragging
              ...
              >
                ...
                {/* 3. Timeline Indicator Node (with gap) */}
                <div className="relative z-1 flex-shrink-0 flex items-center justify-center ml-1 sm:ml-2 mr-1">
                  {isCompleted ? (
                    <div className="w-7 h-7 rounded-full bg-emerald-500 text-white flex items-center justify-center shadow-sm">
                      <Check className="w-4 h-4 stroke-[3]" />
                    </div>
                  ) : isInProgress ? (
                    <div className="w-7 h-7 rounded-full bg-white border-2 border-[#2563eb] flex items-center justify-center shadow-md">
                      <div className="w-3 h-3 rounded-full bg-[#2563eb]" />
                    </div>
                  ) : (
                    <div className="w-7 h-7 rounded-full bg-[#E0E5EC] border-2 border-[#a0aec0] flex items-center justify-center">
