...
import { Flame, Trophy, CheckCircle, Repeat, Target, Heart, ShieldCheck } from 'lucide-react';
...
export const StatsView: React.FC<StatsViewProps> = ({ stats, tasks, privateTasks }) => {
    ...
    const singleTasks = allTasks.filter((t) => !t.isHabit);

    // Highest best streak overall
